      ...
      <div className="card">
          <div className="card__site">
            ...
            <div className='card__site__container'>
              <img className='card__site__container__img' src='/images/download.jpg' />
              <div className='card__site__container__text'>
                <h2>Pollarizer()</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit excepturi repellendus rerum sunt hic a beatae repudiandae, aperiam soluta vitae quidem praesentium adipisci id blanditiis iure quae facilis facere! Ipsum?</p>
              </div>
            </div>
          </div>
        <div className="card__site">
            ...
            <div className='card__site__container'>
              <img className='card__site__container__img' src='/images/weather-3.jpg' />
              <div className='card__site__container__text'>
                <h2>Climático()</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum minus repellendus eius voluptates nam? Exercitationem temporibus, quo at blanditiis optio excepturi eos officia. Necessitatibus ipsa et sed! Eius, quam odio.</p>
              </div>
          </div>
        </div>
        <div className="card__site">
